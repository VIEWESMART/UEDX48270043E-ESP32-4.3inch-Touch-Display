<h1 align = "center">VIEWE 4.3" 480*272 ESP32-S3 Smart Display Quick Guide </h1>
...
> [!NOTE]
> To distinguish between the **800 x 480** and **480 x 272** kit versions, we have named this development board assembly **PLCM-UEDX48270043E-WB-A** based on the resolution of the display screen. The PCB development boards uniformly adopt the designation **UEDX80480043E-WB-A / B**. Please pay attention to the distinction.
...
| :--- | :--- | :--- |
| **Arduino** | `examples/arduino/gui/lvgl_v8` | **LVGL Benchmark**: Demonstrates 480x272 UI rendering. It can also be directly opened in the Arduino IDE. |
...
#### 4.2.1 Preparation
* **Hardware**: PLCM-UEDX48270043E-WB-A or PLCM-UEDX48270043E-WB-B Board, USB-C Cable.
...
5.  **config esp supported panel board**:
    ...
    * ensure you uncomment: `#define BOARD_VIEWE_UEDX48270043E_WB_A`
    ```c
    ...
    /**
...
- [products specification(WB-A)](datasheet/PLCM-UEDX80480043E-WB-A%20V3.2%20SPEC.pdf)
- [products specification(WB-B)](datasheet/PLCM-UEDX80480043E-WB-B%20V1.0%20SPEC.pdf)
- [UEDX80480043E-WB-A Schematic Diagram (PDF)](Schematic/PCB-UEDX48480043E-WB-A%20V1.3.SCH.pdf)
- [UEDX80480043E-WB-B Schematic Diagram (PDF)](Schematic/PCB-UEDX80480043E-WB-B.pdf)
- [2D Drawing (dwg)](2D%20drawings/PLCM-DX80480043E-WB-B.dwg)
- [Display Specification (PDF)](datasheet/UE043HV-RN40-A058B_V1.1.pdf)
- [Display Chip Specification (PDF)](datasheet/ILI6485_DTS_V008_20201113.pdf)
